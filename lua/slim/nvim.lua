...
local follow_3f = true
local function toggleFollow()
  follow_3f = not follow_3f
  return nil
end
_2amodule_2a["toggleFollow"] = toggleFollow
...
local function start_streaming(stream_generator)
  ...
  return stream_generator(_6_, _9_)
end
...
local function stream_into_buffer(stream_generator, prompt)
  ...
  local _let_13_ = open(lines)
  local win = _let_13_[1]
  local buf = _let_13_[2]
...
local function stream_into_empty_buffer(stream_generator, prompt, buffer_name)
  ...
  return stream_generator(prompt, _16_)
end
