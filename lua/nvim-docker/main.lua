...
local commands, core, filetypes, lsps, nano_copilot, prompt_runner, runbooks = require("docker.setup"), require("aniseed.core"), require("filetypes"), require("lsps"), require("nano-copilot"), require("prompts.runner"), require("runbooks")
...
_2amodule_locals_2a["prompt-runner"] = prompt_runner
