...
local _2amodule_name_2a = "nvim-docker-ai.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-docker-ai.aniseed.core"), autoload("nvim-docker-ai.aniseed.fs"), autoload("nvim-docker-ai.aniseed.nvim"), autoload("nvim-docker-ai.aniseed.string")
...
local function impl()
  local compiler = require("nvim-docker-ai.aniseed.deps.fennel")
