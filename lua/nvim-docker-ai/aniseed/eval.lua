...
local _2amodule_name_2a = "nvim-docker-ai.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-docker-ai.aniseed.core"), autoload("nvim-docker-ai.aniseed.compile"), autoload("nvim-docker-ai.aniseed.fennel"), autoload("nvim-docker-ai.aniseed.fs"), autoload("nvim-docker-ai.aniseed.nvim")
