...
local _2amodule_name_2a = "nvim-docker-ai.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-docker-ai.aniseed.core"), autoload("nvim-docker-ai.aniseed.fennel"), autoload("nvim-docker-ai.aniseed.fs"), autoload("nvim-docker-ai.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "nvim-docker-ai.aniseed.macros"
  local filename
  do
