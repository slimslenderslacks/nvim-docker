...
local _2amodule_name_2a = "nvim-docker-ai.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-docker-ai.aniseed.compile"), autoload("nvim-docker-ai.aniseed.fennel"), autoload("nvim-docker-ai.aniseed.fs"), autoload("nvim-docker-ai.aniseed.nvim")
