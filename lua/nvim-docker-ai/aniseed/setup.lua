...
local _2amodule_name_2a = "nvim-docker-ai.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-docker-ai.aniseed.core"), autoload("nvim-docker-ai.aniseed.env"), autoload("nvim-docker-ai.aniseed.eval"), autoload("nvim-docker-ai.aniseed.nvim")
