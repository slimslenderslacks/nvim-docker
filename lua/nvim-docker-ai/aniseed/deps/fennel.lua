package.preload["nvim-docker-ai.aniseed.fennel.repl"] = package.preload["nvim-docker-ai.aniseed.fennel.repl"] or function(...)
  local utils = require("nvim-docker-ai.aniseed.fennel.utils")
  local parser = require("nvim-docker-ai.aniseed.fennel.parser")
  local compiler = require("nvim-docker-ai.aniseed.fennel.compiler")
  local specials = require("nvim-docker-ai.aniseed.fennel.specials")
  local view = require("nvim-docker-ai.aniseed.fennel.view")
...
package.preload["nvim-docker-ai.aniseed.fennel.specials"] = package.preload["nvim-docker-ai.aniseed.fennel.specials"] or function(...)
  local utils = require("nvim-docker-ai.aniseed.fennel.utils")
  local view = require("nvim-docker-ai.aniseed.fennel.view")
  local parser = require("nvim-docker-ai.aniseed.fennel.parser")
  local compiler = require("nvim-docker-ai.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "nvim-docker-ai.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["nvim-docker-ai.aniseed.fennel.compiler"] = package.preload["nvim-docker-ai.aniseed.fennel.compiler"] or function(...)
  local utils = require("nvim-docker-ai.aniseed.fennel.utils")
  local parser = require("nvim-docker-ai.aniseed.fennel.parser")
  local friend = require("nvim-docker-ai.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["nvim-docker-ai.aniseed.fennel.friend"] = package.preload["nvim-docker-ai.aniseed.fennel.friend"] or function(...)
  local utils = require("nvim-docker-ai.aniseed.fennel.utils")
...
package.preload["nvim-docker-ai.aniseed.fennel.parser"] = package.preload["nvim-docker-ai.aniseed.fennel.parser"] or function(...)
  local utils = require("nvim-docker-ai.aniseed.fennel.utils")
  local friend = require("nvim-docker-ai.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["nvim-docker-ai.aniseed.fennel.view"] = package.preload["nvim-docker-ai.aniseed.fennel.view"] or function(...)
...
package.preload["nvim-docker-ai.aniseed.fennel.utils"] = package.preload["nvim-docker-ai.aniseed.fennel.utils"] or function(...)
  local view = require("nvim-docker-ai.aniseed.fennel.view")
  local version = "1.3.0"
...
utils = require("nvim-docker-ai.aniseed.fennel.utils")
local parser = require("nvim-docker-ai.aniseed.fennel.parser")
local compiler = require("nvim-docker-ai.aniseed.fennel.compiler")
local specials = require("nvim-docker-ai.aniseed.fennel.specials")
local repl = require("nvim-docker-ai.aniseed.fennel.repl")
local view = require("nvim-docker-ai.aniseed.fennel.view")
...
do
  local module_name = "nvim-docker-ai.aniseed.fennel.macros"
  local _
